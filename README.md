...
**R support is Preview.** Supported R frames can be viewed, cleaned and exported. The
...
defines the qualification and reliability review required for stable support. Default `collapse::qDF()`, `qTBL()` and `qDT()` outputs
