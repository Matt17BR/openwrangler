...
Google documents Antigravity as a VS Code-based editor with an [Open VSX extension path](https://antigravity.google/docs/editor), but Open Wrangler has not completed a functional smoke there yet. Experimental editors do not inherit the VS Code/Cursor support guarantee.
