...
The 1.2.1 Data Wrangler table may stay in preview documentation while it is labelled 1.2.1. Before releasing 2.0,
rerun the comparison using the final candidate VSIX and replace the README table and reviewed report with the 2.0
results.
