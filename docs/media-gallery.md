...
<table>
  ...
  <tr>
    <td>Search or browse 30 operations, including multi-output literal splitting and portable regular-expression extraction, custom code, and transformations inferred from examples.</td>
