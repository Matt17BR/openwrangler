...
local-source contracts now own the strict ordered 29-operation live/generated catalog and byte-exact clipboard/atomic
script exports of distinct executable operation-labelled buffers. Current source therefore exposes all 29 operations
but remains **Partial** until a fresh hosted candidate plus installed all-29 and performance evidence pass. The private
