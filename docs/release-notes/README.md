...
Add one Markdown file for each stable or manual preview release, for example `2.1.1.md`. Write it in the release pull
...
For stable and manual preview releases, the publisher reads this file from the exact tagged commit and sends its text
