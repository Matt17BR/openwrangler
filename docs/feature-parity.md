...
extension can own the complete spawned process tree. Current source exposes all 28 native-R operations; the latest
published preview and the hosted evidence still cover only the earlier catalog.
