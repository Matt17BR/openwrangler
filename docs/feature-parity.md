...
| R cleaning operations and generated code      | 21 operations                   | Partial | All 21 installed; compatible Group By views survive replacement/apply and reconcile on undo     | Preview release |
