...
| Notebook workbench                            | 1.99 preview                    | Partial | Packaged viewing/editing plus focused same-public-session Native-R recovery; scalar installed restart remains pending                             | Preview release |
