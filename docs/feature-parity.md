...
negative integer literals with magnitude at most UInt64 maximum when every result fits UInt64. Existing native
successes remain unchanged. Negative-column, negative multiply/power and widest or negative-scale Decimal capacity
gaps remain tracked in [#979](https://github.com/Matt17BR/openwrangler/issues/979).
