...
| Cross-platform first-class editor package acceptance |    N/A |    N/A | Done   | The canonical candidate runs pinned VS Code installed-performance and pinned Cursor platform-smoke; workflow:.github/workflows/release-candidate.yml; record:docs/testing.md                   |
