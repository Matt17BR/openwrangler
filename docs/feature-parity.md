...
| Editing mode and operation catalog                  |    Yes |    Yes | Partial | Finish structural/group/by-example duplicate matrix  |
...
| Duplicate/non-string Pandas column operations       |   View |    N/A | Partial | Finish structural/group/by-example packaged matrix   |
