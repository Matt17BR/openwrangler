...
The compatibility authority records VS Code 1.130.0 on Linux, macOS, Windows at the **Fully qualified** tier and Cursor 3.13.10 on Linux at the **Focused release seam** tier. Native R 4.4.3 and 4.5.2 coverage is a **Focused release seam**, not full product qualification; its promotion remains tied to [issue #87](https://github.com/Matt17BR/openwrangler/issues/87).
