...
The compatibility authority records VS Code 1.130.0 on Linux, macOS, Windows at the **Fully qualified** tier and Cursor 3.13.10 on Linux at the **Focused release seam** tier. Its separate Open Wrangler 1.2.0/Antigravity 1.107.0 Linux x64 record is **Smoke-tested** and does not promote other desktop forks above API-compatible. Native R 4.4.3 and 4.5.2 coverage is a **Focused release seam**, not full product qualification; its promotion remains tied to [issue #87](https://github.com/Matt17BR/openwrangler/issues/87).
