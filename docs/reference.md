...
| -------------------------------------- | --------- | ---------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `openWrangler.defaultBackend`          | `string`  | `"auto"`                                       | `"auto"`, `"polars"`, `"duckdb"`, `"pandas"`, `"r"`       | Default file engine. Auto selects the first available Python engine in Polars, DuckDB, then Pandas order, subject to file-format and import-option support. R opens local UTF-8 CSV/TSV files natively on Linux and macOS using Rscript. It does not fall back to Python for unsupported files. Auto does not switch engines after a file-read error. Open DuckDB Table always uses DuckDB. |
