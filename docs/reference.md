...
| -------------------------------------- | --------- | ---------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `openWrangler.defaultBackend`          | `string`  | `"auto"`                                       | `"auto"`, `"polars"`, `"duckdb"`, `"pandas"`              | Default backend for file-backed sessions. Auto selects the first available engine in Polars, DuckDB, then Pandas order, subject to file-format and import-option support. It does not switch engines after a file-read error. |
