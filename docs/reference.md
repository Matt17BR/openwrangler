...
| -------------------------------------- | --------- | ---------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `openWrangler.defaultBackend`          | `string`  | `"auto"`                                       | `"auto"`, `"polars"`, `"duckdb"`, `"pandas"`, `"r"`       | Default file engine. Auto selects the first available Python engine in Polars, DuckDB, then Pandas order, subject to file-format and import-option support. If no compatible Python interpreter or engine is available, Auto tries R for supported files. Explicit Python engine choices, broken configured interpreter paths and unexpected environment errors do not select R. R opens local CSV, TSV, Parquet, JSONL/NDJSON and Excel files natively on Linux and macOS using Rscript, with format-specific limits and optional packages. It does not fall back to Python for unsupported files. Auto does not switch engines after a file-read error. Open DuckDB Table always uses DuckDB. |
...
| `openWrangler.rscriptPath`             | `string`  | `""`                                           | None                                                      | Optional Rscript executable used for native R local files and .R, .Rmd, and .qmd documents on macOS or Linux. When empty, Open Wrangler resolves Rscript from PATH.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
