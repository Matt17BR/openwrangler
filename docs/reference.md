...
| `openWrangler.insightsOnOpen`          | `boolean` | `true`                                         | None                                                      | Show progressive profiles in visible grid headers when a grid opens. PySpark always starts with header profiles off because each profile runs Spark work.                                              |
