...
> Generated from `package.json` and `protocol/openwrangler.v3.schema.json`. Do not edit this file by hand; run `npm run generate:reference`.
...
Canonical schema: `protocol/openwrangler.v3.schema.json`. Protocol version: `3`.
