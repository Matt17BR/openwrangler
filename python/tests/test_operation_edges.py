...
@pytest.mark.parametrize(
    ...
    + [
        ...
        ("power", "int64[pyarrow]", [2, 1, None], "int64[pyarrow]", [63, 63, 63], "uint64[pyarrow]", [2**63, 1, None]),
        ("power", "int8[pyarrow]", [2, 3, None], "int8[pyarrow]", [63, 40, 1], "uint64[pyarrow]", [2**63, 3**40, None]),
        ("power", "int8", [2, 3, 1], "int8[pyarrow]", [63, 40, None], "uint64[pyarrow]", [2**63, 3**40, None]),
        ("power", "Int8", [2, None, 3], "uint32[pyarrow]", [63, 40, 40], "uint64[pyarrow]", [2**63, None, 3**40]),
        (
            "power",
            "int8[pyarrow]",
            [None, 2, 3, 1],
        ...
        ("power", "int64[pyarrow]", [2, -2, None], "int64[pyarrow]", [63, 63, 1], None, None),
        ("power", "int64[pyarrow]", [2, -2, None], "int64[pyarrow]", [63, 62, 1], None, None),
        ("power", "int64[pyarrow]", [2, -1, None], "int64[pyarrow]", [63, None, 1], None, None),
        ("power", "int64[pyarrow]", [2, None, 1], "int64[pyarrow]", [63, -1, 1], None, None),
        (
            "power",
            "int64[pyarrow]",
            [-(2**63), 1, None],
        ...
        ("power", "int64[pyarrow]", [1, None], "int64[pyarrow]", [-(2**63), 1], None, None),
        ("power", "int64[pyarrow]", [2, 1, None], "int64[pyarrow]", [64, 0, 1], None, None),
