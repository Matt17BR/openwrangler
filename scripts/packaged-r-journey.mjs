...
const R_JUPYTER_SELECTORS = new Set(["interactive-terminal", "literate-documents", REMOTE_R_JUPYTER_SELECTOR]);
...
export function resolvePackagedRJourneySelection({
  ...
  if (selector !== undefined && !R_JUPYTER_SELECTORS.has(selector)) {
    throw new Error(
      'OPEN_WRANGLER_PACKAGED_R_JOURNEY must be unset, "interactive-terminal", "literate-documents", or "remote-r-jupyter".'
    );
  }
