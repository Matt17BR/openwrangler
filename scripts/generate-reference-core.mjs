...
async function generateReference() {
  ...
  const schema = JSON.parse(readFileSync(resolve(root, "protocol", "openwrangler.v4.schema.json"), "utf8"));
  ...
  return prettier.format(
    `${[
      ...
      "",
      `## Runtime protocol v${schema.definitions.ProtocolVersion.enum.join(", ")}`,
      "",
      `Canonical schema: \`protocol/openwrangler.v4.schema.json\`. Protocol version: \`${schema.definitions.ProtocolVersion.enum.join(", ")}\`.`,
      "",
      table(
