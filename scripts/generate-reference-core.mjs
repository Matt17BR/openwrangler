...
async function generateReference() {
  ...
  const schema = JSON.parse(readFileSync(resolve(root, "protocol", "openwrangler.v3.schema.json"), "utf8"));
  ...
  return prettier.format(
    `${[
      ...
      "",
      `Canonical schema: \`protocol/openwrangler.v3.schema.json\`. Protocol version: \`${schema.definitions.ProtocolVersion.enum.join(", ")}\`.`,
      "",
      table(
