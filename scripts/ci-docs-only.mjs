      ...
      : rEditorOmittable
        ...
        : rOmittable && pythonOmittable
          ...
          : rOmittable
            ...
            : rRuntimeOmittable
              ? "Verified renderer edits permit omission of Python, native R source and Windows filesystem and process checks; platform artifact, package and installed-editor checks remain required."
              : pythonOmittable
