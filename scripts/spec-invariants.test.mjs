...
test("cleaning-history report clauses retain structural owners and recognize rollback spellings", () => {
  const model = cleaningHistoryModel();
  const contradictions = [
    "A report lists committed steps, but none can be edited.",
    "A report lists two committed steps, and neither can be edited.",
    "A report lists two committed steps: both cannot be edited.",
    "A report lists committed steps that cannot be edited.",
    "A report lists committed steps which cannot be edited.",
    "A report lists committed steps as unavailable for editing.",
    "Committed steps generate a report and cannot be edited.",
    "Committed steps produce a report, but cannot be edited.",
    "Committed steps that generate a report cannot be edited.",
    "Every committed step can be rolled back.",
    "Every committed step can be rolled-back.",
    "Every committed step was rolled back.",
    "Every committed step was rolled-back.",
    "Roll back applies to every committed step.",
    "Roll-back applies to every committed step."
  ];
  const truthful = [
    "A report with committed steps cannot be edited.",
    "A report summarizes committed steps and cannot be edited.",
    "A report mentions committed steps, but cannot be edited.",
    "A report generated by committed steps cannot be edited.",
    "A report produced by committed steps; it cannot be edited.",
    "A report that lists committed steps cannot be edited.",
    "A report which summarizes committed steps cannot be edited.",
    "Committed steps generate a report that cannot be edited.",
    "Committed steps produce a report; it cannot be edited.",
    "Only the latest committed step can be rolled back.",
    "Only the latest committed step can be rolled-back.",
    "Only the latest committed step was rolled back.",
    "Only the latest committed step was rolled-back."
  ];
...
test("cleaning-history matrix clauses and rendered rollback spellings preserve exact ownership", () => {
  const model = cleaningHistoryModel();
  const contradictions = [
    "A report listing committed steps says they cannot be edited.",
    "Committed steps listed in a report cannot be edited.",
    "Committed steps listed by a report cannot be edited.",
    "Committed steps generating a report cannot be edited.",
    "Committed steps that a report lists cannot be edited.",
    "Committed steps which a report lists cannot be edited.",
    "Committed steps that are listed by a report cannot be edited.",
    "Committed steps, which a report lists, cannot be edited.",
    "Committed steps, listed by a report, cannot be edited.",
    "Committed steps listed by a report, but cannot be edited.",
    "Committed steps that a report lists, cannot be edited.",
    "Committed steps, generating a report, cannot be edited.",
    "A report's committed steps cannot be edited.",
    "Reports' committed steps cannot be edited.",
    "A report’s committed steps cannot be edited.",
    "Every committed step can be rolled    back.",
    "Every committed step was rolled    back.",
    "Every committed step was rolled—back.",
    "Every committed step was rolled&#x2014;back.",
    "Every committed step was rolled&mdash;back.",
    "Users can roll every committed step back.",
    "Users can roll each previously committed step back.",
    "Users can roll each of the already once previously selected visible current single committed step back.",
    "Every committed step can be roll—back.",
    "Every committed step can be roll&#x2014;back.",
    "Every committed step can be roll&mdash;back.",
    "Every committed step can be roll&#x2d;back."
  ];
  const truthful = [
    "A report listing committed steps cannot be edited.",
    "A report that lists committed steps cannot be edited.",
    "A report, which lists committed steps, cannot be edited.",
    "A report generated by committed steps cannot be edited.",
    "A report, generated by committed steps, cannot be edited.",
    "A report that is generated by committed steps cannot be edited.",
    "A report listing committed steps, but cannot be edited.",
    "A report, listing committed steps, cannot be edited.",
    "A committed step's report cannot be edited.",
    "Committed steps' report cannot be edited.",
    "Committed steps’ report cannot be edited.",
    "A report's listing of committed steps cannot be edited.",
    "Users can roll only the latest committed step back.",
    "Only the latest committed step was rolled    back.",
    "Only the latest committed step was rolled—back.",
    "Only the latest committed step was rolled&mdash;back.",
    "The report can roll forward and back through pages.",
    "Users can roll the report back."
  ];
  ...
  assert.throws(
    () =>
      assertCleaningHistoryClaimsCurrent({
        ...
        documents: cleaningHistoryDocumentsWithReadmeClaim(
          model,
          "Users can roll each of the already once previously selected visible current single one committed step back."
        )
      }),
    /exceeds the 12-token capability ownership window/u
  );
...
test("cleaning-history structural owners survive modifiers, extra nouns, and finite attribution parentheticals", () => {
  const model = cleaningHistoryModel();
  const contradictions = [
    "Committed steps that a detailed report about cleaning lists cannot be edited.",
    "Committed steps listed by a detailed report about cleaning cannot be edited.",
    "Committed steps about which a detailed report about cleaning was generated cannot be edited.",
    "Committed steps about a report that lists other committed steps cannot be edited.",
    "Committed steps about a report with another report that lists them cannot be edited.",
    "Committed steps, a report says, cannot be edited.",
    "Committed steps, the report notes, cannot be edited.",
    "Committed steps, the detailed report confirms, cannot be edited.",
    "Committed steps—a detailed report about cleaning says—cannot be edited.",
    "Committed steps—the report notes—cannot be edited.",
    "Committed steps—the detailed report confirms—cannot be edited."
  ];
  const truthful = [
    "A detailed report about cleaning that lists committed steps cannot be edited.",
    "A detailed report about cleaning generated by committed steps cannot be edited.",
    "A detailed report about cleaning, which committed steps generate, cannot be edited.",
    "A report about committed steps that list another report cannot be edited.",
    "A detailed report about cleaning with another report that lists committed steps cannot be edited.",
    "A report, committed steps say, cannot be edited.",
    "The report, committed steps note, cannot be edited.",
    "A report, committed steps confirm, cannot be edited.",
    "A report—committed steps say—cannot be edited.",
    "The report—committed steps note—cannot be edited.",
    "A report—committed steps confirm—cannot be edited."
  ];
...
test("cleaning-history phrasal rollback keeps bounded cleaning ownership across modifier positions", () => {
  const model = cleaningHistoryModel();
  const contradictions = [
    "Users can slowly roll every committed step back.",
    "Users can immediately roll every committed step back.",
    "Users can roll carefully back every committed step.",
    "Users can roll immediately back every committed step.",
    "Users can roll every committed step carefully back.",
    "Users can roll every committed step immediately back.",
    "Users can roll, carefully, every committed step back.",
    "Users can roll, immediately, every committed step back.",
    "Users can roll every committed step back slowly."
  ];
  const truthful = [
    "Users can slowly roll only the latest committed step back.",
    "Users can immediately roll only the latest committed step back.",
    "Users can roll carefully back only the latest committed step.",
    "Users can roll immediately back only the latest committed step.",
    "Users can roll only the latest committed step carefully back.",
    "Users can roll only the latest committed step immediately back.",
    "Users can roll, carefully, only the latest committed step back.",
    "Users can roll, immediately, only the latest committed step back.",
    "Users can roll only the latest committed step back slowly.",
    "Users can slowly roll the report back.",
    "Users can roll carefully back through the report.",
...
test("cleaning-history visible tokens are bounded before claim canonicalization", () => {
  ...
  const exactInlineExample = `\`${"sample ".repeat(4093).trim()}\` is an example.`;
  const oversizedInlineExample = `\`${"sample ".repeat(4094).trim()}\` is an example.`;
  assert.doesNotThrow(() =>
    assertCleaningHistoryClaimsCurrent({
      modelSource: JSON.stringify(model),
      productionAuthoritySource: cleaningHistoryProductionAuthoritySource(),
      documents: cleaningHistoryDocumentsWithReadmeClaim(model, exactInlineExample)
    })
  );
  assert.throws(
    () =>
  ...
  assert.throws(
    () =>
      assertCleaningHistoryClaimsCurrent({
        modelSource: JSON.stringify(model),
        productionAuthoritySource: cleaningHistoryProductionAuthoritySource(),
        documents: cleaningHistoryDocumentsWithReadmeClaim(model, oversizedInlineExample)
      }),
    /exceeds the 4096-word-token work limit/u
  );
});
