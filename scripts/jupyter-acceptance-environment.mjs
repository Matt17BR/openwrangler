...
// R adds an existing R_LIBS_USER directory to .libPaths() during startup. Keep
// the kernelspec's -e argument to IRkernel's standard one-expression form so
// Windows launchers never have to re-quote a multi-statement R program.
