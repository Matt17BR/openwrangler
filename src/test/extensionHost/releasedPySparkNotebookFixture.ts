  ...
  return {
    cells: [
      ...
      cell([
        ...
        "import sys",
        "import tempfile",
        "_open_wrangler_spark_temp = tempfile.gettempdir()",
        "if ',' in _open_wrangler_spark_temp:",
        "    raise RuntimeError('Spark acceptance requires a temporary directory without commas')",
        "os.environ['SPARK_LOCAL_DIRS'] = _open_wrangler_spark_temp",
