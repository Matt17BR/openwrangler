...
describe("Fill Missing operation fields", () => {
  ...
  it.each([
    {
      caseName: "target repeated as a fallback",
      step: {
        id: "fill-self",
        kind: "fillMissingValues",
        params: {
    ...
    {
      caseName: "fallback with a different type",
      step: {
        id: "fill-wrong-type",
        kind: "fillMissingValues",
        params: {
    ...
    {
      caseName: "target repeated as a calculation-order column",
      step: {
    ...
    {
      caseName: "target repeated as a group key",
      step: {
    ...
    "blocks editing when the saved fill $caseName",
    ({ step, message }) => {
      const onClose = vi.fn();
      const onPreview = vi.fn();
      render(
